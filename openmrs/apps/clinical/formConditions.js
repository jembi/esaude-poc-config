...
"Conduct_Contraceptive_Methods_MAL_Lactational_Amenorrhea_Method_button","Conduct_Contraceptive_Methods_OUT_Other_button"]
    ...
    "Group_VIII_Conduct_obs_form"(formName, formFieldValues, patient) {
        var form = formName["Group_VIII_Conduct_obs_form"];
        var formFields = formFieldValues["Group_VIII_Conduct_obs_form"];

        if (form === "Group_VIII_Conduct_obs_form") {
            return {
            ...
            return {
                hide: ["Conduct_Contraceptive_Methods_PRES_Condom_button","Conduct_Contraceptive_Methods_VAS_Vasectomy_button","Conduct_Contraceptive_Methods_OUT_Other_button"],
