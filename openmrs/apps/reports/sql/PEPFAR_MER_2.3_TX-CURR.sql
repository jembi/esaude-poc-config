select
   ...
   case
      when
         (
            p.gender = 'M' 
            and TIMESTAMPDIFF( YEAR, p.birthdate, '#endDate#') < 1 
         )
      then
         1 
      else
   ...
   case
      when
         (
            p.gender = 'M' 
            and TIMESTAMPDIFF( YEAR, p.birthdate, '#endDate#') BETWEEN 1 and 4 
         )
      then
         1 
      else
   ...
   case
      when
         (
            p.gender = 'M' 
            and TIMESTAMPDIFF( YEAR, p.birthdate, '#endDate#') BETWEEN 5 and 9 
         )
      then
         1 
      else
   ...
   case
      when
         (
            p.gender = 'M' 
            and TIMESTAMPDIFF( YEAR, p.birthdate, '#endDate#') BETWEEN 10 and 14 
         )
      then
         1 
      else
   ...
   case
      when
         (
            p.gender = 'M' 
            and TIMESTAMPDIFF( YEAR, p.birthdate, '#endDate#') BETWEEN 15 and 19 
         )
      then
         1 
      else
   ...
   case
      when
         (
            p.gender = 'M' 
            and TIMESTAMPDIFF( YEAR, p.birthdate, '#endDate#') BETWEEN 20 and 24 
         )
      then
         1 
      else
   ...
   case
      when
         (
            p.gender = 'M' 
            and TIMESTAMPDIFF( YEAR, p.birthdate, '#endDate#') BETWEEN 25 and 29 
         )
      then
         1 
      else
   ...
   case
      when
         (
            p.gender = 'M' 
            and TIMESTAMPDIFF( YEAR, p.birthdate, '#endDate#') BETWEEN 30 and 34 
         )
      then
         1 
      else
   ...
   case
      when
         (
            p.gender = 'M' 
            and TIMESTAMPDIFF( YEAR, p.birthdate, '#endDate#') BETWEEN 35 and 39 
         )
      then
         1 
      else
   ...
   case
      when
         (
            p.gender = 'M' 
            and TIMESTAMPDIFF( YEAR, p.birthdate, '#endDate#') BETWEEN 40 and 44 
         )
      then
         1 
      else
   ...
   case
      when
         (
            p.gender = 'M' 
            and TIMESTAMPDIFF( YEAR, p.birthdate, '#endDate#') BETWEEN 45 and 49 
         )
      then
         1 
      else
   ...
   case
      when
         (
            p.gender = 'M' 
            and TIMESTAMPDIFF( YEAR, p.birthdate, '#endDate#') >= 50 
         )
      then
         1 
      else
...
(date_add(date_add(erp.dispensed_date, interval dor.quantity DAY ), interval 31 DAY)) > DATE('#endDate#')
   ...
   and pss.patient_status is null 
